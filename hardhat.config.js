...
const PREV_SOLC_COMPILER_SETTINGS = JSON.parse(JSON.stringify(DEFAULT_COMPILER_SETTINGS));
PREV_SOLC_COMPILER_SETTINGS.version = '0.8.19';
PREV_SOLC_COMPILER_SETTINGS.settings.evmVersion = 'paris';

const LOW_OPTIMIZER_COMPILER_SETTINGS = JSON.parse(JSON.stringify(PREV_SOLC_COMPILER_SETTINGS));
