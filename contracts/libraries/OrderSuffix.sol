...
library OrderSuffix {
    ...
    uint256 private constant _AUCTION_POINT_DELAY_BYTES_SIZE = 1;
    uint256 private constant _AUCTION_POINT_BUMP_BYTES_SIZE = 3;
    uint256 private constant _AUCTION_POINT_BYTES_SIZE = 4; // _AUCTION_POINT_DELAY_BYTES_SIZE + _AUCTION_POINT_BUMP_BYTES_SIZE;
    uint256 private constant _AUCTION_POINT_DELAY_BIT_SHIFT = 248; // 256 - _AUCTION_POINT_DELAY_BYTES_SIZE * 8;
